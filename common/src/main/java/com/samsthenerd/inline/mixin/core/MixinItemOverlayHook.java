...
//    }
    ...
    public void renderDetailTextureBakedModel(ItemRenderer renderer, LivingEntity entity, ItemStack stack, ModelTransformationMode renderMode, boolean leftHanded, MatrixStack matrices, VertexConsumerProvider vcp, World world, int light, int overlay, int seed, Operation<Void> original) {
...
//    }
    ...
    public void renderDetailTextureBuiltInModel(ItemRenderer renderer, LivingEntity entity, ItemStack stack, ModelTransformationMode renderMode, boolean leftHanded, MatrixStack matrices, VertexConsumerProvider vcp, World world, int light, int overlay, int seed, Operation<Void> original) {
        original.call(renderer, entity, stack, renderMode, leftHanded, matrices, vcp, world, light, overlay, seed);
        matrices.pop();
        matrices.push();
        matrices.translate(-0.5F, -0.5F, -0.5F);
